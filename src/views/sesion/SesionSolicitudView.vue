...
<br>    
<!-- Titutlo -->
<h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Solicitudes de la Sesión #</h2>

</div>
<!-- Contenedor Primario  -->
    <div class="centroSolicitud">
        <!-- Tabla de Solicitud  -->
