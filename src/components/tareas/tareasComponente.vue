...
<script setup>
import ModalCreateTarea from './ModalCreateTarea.vue';
import ModalEditTarea from './ModalEditTarea.vue';
</script>
<template>
    <div class="titleTarea">
<!-- Tituto -->
<h2 class="mb-4 text-3xl font-extrabold leading-none tracking-tight text-gray-900 md:text-4xl dark:text-white">Tareas</h2>

</div>
    <div class="centroTarea">
