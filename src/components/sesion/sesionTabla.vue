...
<template>
           ...
           <div>
               ...
               <div id="dropdownAction" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                   <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownActionButton">
                       <li>
                           <button @click="openModal" class="flex flex-row items-center gap-x-2 px-4 py-2 w-full hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
           ...
           <tr v-for="element in props.data" :key="element.IDSESION" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
               ...
               <td class="px-6 py-4">
                   <div class="flex flex-row justify-between items-center">
                       <!--Editar-->
                        <div>
                           <svg @click="updateSession(element.IDSESION)" class="w-[18px] h-[18px] icon-button" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                       ...
                       <!--Ver-->
                       <div>
                           <svg @click="viewSessionAction" class="w-[18px] h-[18px] icon-button" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
   ...
   const updateSession = (idSession) => {
        sessionStore.setOnUpdateMode(true);
        openModal();
        emit('updateSession', idSession);
   }
