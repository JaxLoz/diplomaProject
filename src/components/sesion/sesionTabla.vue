           ...
           <tr v-for="element in props.data" :key="element.id" class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
               ...
               <td class="px-6 py-4">
                   <div class="flex flex-row justify-between items-center">
                       <!--Editar-->
                        <div>
                           <svg @click="updateSession(element.id)" class="w-[18px] h-[18px] icon-button" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
