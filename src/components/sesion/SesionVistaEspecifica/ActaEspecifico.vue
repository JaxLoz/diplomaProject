          ...
          <tbody>
            ...
            >
              ...
              <td class="px-4 py-4">
                ...
                <div v-if="(props.profile?.rol == 'coordinador' || props.profile?.rol == 'secretario' || props.profile?.rol == 'miembro' || props.profile?.rol =='invitado' || props.profile?.rol =='estudiante') && acta.ESTADO != 'pendiente' || ( props.profile?.rol == 'miembro' || props.profile?.rol =='invitado' || props.profile?.rol =='estudiante') && acta.ESTADO == 'pendiente'" 
                ...
                <select
                  ...
                  v-if="(props.profile?.rol == 'coordinador' || props.profile?.rol == 'secretario') && acta.ESTADO == 'pendiente'"
